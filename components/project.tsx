...
export default function Project({
	...
	return (
		...
		>
			...
			>
				<div className=' sm:group-even:ml-[28rem]  h-full flex flex-col pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%]'>
				...
				<Image
					...
					quality={95}
					className=' transition group-hover:scale-[1.25] group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-10 group-even:group-hover:rotate-2 group-even:right-[initial] group-even:-left-40 absolute top-8 -right-20 w-[30.25rem] rounded-t-lg shadow-2xl responsive'
					// hidden sm:block
				/>
			</section>
		</motion.div>
